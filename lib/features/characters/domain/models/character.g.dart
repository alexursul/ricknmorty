...
const CharacterSchema = CollectionSchema(
  ...
  links: {},
  embeddedSchemas: {
    r'CharacterOrigin': CharacterOriginSchema,
    r'CharacterLocation': CharacterLocationSchema
  },
...
int _characterEstimateSize(
  ...
  bytesCount += 3 +
      CharacterLocationSchema.estimateSize(
          object.location, allOffsets[CharacterLocation]!, allOffsets);
  bytesCount += 3 + object.name.length * 3;
  bytesCount += 3 +
      CharacterOriginSchema.estimateSize(
          object.origin, allOffsets[CharacterOrigin]!, allOffsets);
...
void _characterSerialize(
  ...
  writer.writeObject<CharacterLocation>(
    offsets[4],
    allOffsets,
    CharacterLocationSchema.serialize,
    object.location,
  );
  writer.writeString(offsets[5], object.name);
  writer.writeObject<CharacterOrigin>(
    offsets[6],
    allOffsets,
    CharacterOriginSchema.serialize,
    object.origin,
  );
...
Character _characterDeserialize(
  ...
  final object = Character(
    ...
    location: reader.readObjectOrNull<CharacterLocation>(
          offsets[4],
          CharacterLocationSchema.deserialize,
          allOffsets,
        ) ??
        CharacterLocation(),
    name: reader.readString(offsets[5]),
    origin: reader.readObjectOrNull<CharacterOrigin>(
          offsets[6],
          CharacterOriginSchema.deserialize,
          allOffsets,
        ) ??
        CharacterOrigin(),
    species: reader.readString(offsets[7]),
    status: _CharacterstatusValueEnumMap[reader.readByteOrNull(offsets[8])] ??
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_CharactergenderValueEnumMap[reader.readByteOrNull(offset)] ??
          CharacterGender.male) as P;
    case 3:
      return (reader.readString(offset)) as P;
    case 4:
      return (reader.readObjectOrNull<CharacterLocation>(
            offset,
            CharacterLocationSchema.deserialize,
            allOffsets,
          ) ??
          CharacterLocation()) as P;
    case 5:
      return (reader.readString(offset)) as P;
    case 6:
      return (reader.readObjectOrNull<CharacterOrigin>(
            offset,
            CharacterOriginSchema.deserialize,
            allOffsets,
          ) ??
          CharacterOrigin()) as P;
    case 7:
      return (reader.readString(offset)) as P;
    case 8:
...
extension CharacterQueryObject
    on QueryBuilder<Character, Character, QFilterCondition> {
  QueryBuilder<Character, Character, QAfterFilterCondition> location(
      FilterQuery<CharacterLocation> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'location');
    });
  }

  QueryBuilder<Character, Character, QAfterFilterCondition> origin(
      FilterQuery<CharacterOrigin> q) {
    return QueryBuilder.apply(this, (query) {
...
extension CharacterQueryProperty
  ...
  QueryBuilder<Character, CharacterLocation, QQueryOperations>
      locationProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Character, CharacterOrigin, QQueryOperations> originProperty() {
    return QueryBuilder.apply(this, (query) {
...
_$_Character _$$_CharacterFromJson(Map<String, dynamic> json) => _$_Character(
      ...
      created: stringToDateTime(json['created'] as String),
    );
...
Map<String, dynamic> _$$_CharacterToJson(_$_Character instance) =>
    <String, dynamic>{
      ...
      'url': instance.url,
      'created': dateTimeToString(instance.created),
    };
